...
async def next_page(bot, query):
    ...
    btn.insert(0,
            [
                InlineKeyboardButton("⭕️ Movie", url="https://t.me/netflixOxG"),
                InlineKeyboardButton("Series ⭕️", url="https://t.me/netflixOxG")
            ])
    ...
    if query.data.startswith("file"):
        ...
        buttons = [
            [
                ...
                InlineKeyboardButton('Channel ⭕️', url='https://t.me/netflixOxG')
            ],
            [
        ...
        buttons = [[
            ...
            InlineKeyboardButton('⭕️ Updates', url='https://t.me/netflixOxG'),
            InlineKeyboardButton('Movie Club ⭕️', url='https://t.me/netflixOxG')
            ],[
        ...
        buttons = [[
            InlineKeyboardButton('⭕ Status', url='https://t.me/netflixOxG/221'),
...
async def auto_filter(client, msg, spoll=False):
    ...
    btn.insert(0, [
        InlineKeyboardButton("⭕️ Join Our Channel ⭕️",url="https://t.me/netflixOxG/4")
    ])
    ...
    if imdb and imdb.get('poster'):
        try:
            ...
            logger.exception(e)
            fek = await message.reply_photo(photo="https://telegra.ph/file/b16e043dd1a0f696c4e53.jpg", caption=cap, reply_to_message_id=reply_id, reply_markup=InlineKeyboardMarkup(btn))
            await asyncio.sleep(36000)
            await fek.delete()
            await msg.delete()
    else:
        fuk = await message.reply_photo(photo="https://telegra.ph/file/b16e043dd1a0f696c4e53.jpg", caption=cap, reply_to_message_id=reply_id, reply_markup=InlineKeyboardMarkup(btn))
        await asyncio.sleep(36000)
        await fuk.delete()
        await msg.delete()
    if spoll:
